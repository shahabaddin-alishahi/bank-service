...
import energizeglobalservices.bankservice.config.feign.FallbackException;
import energizeglobalservices.bankservice.config.feign.FeignException;
...
public class ExceptionAdviceHandler {
    ...
    private ErrorContent translateException(Exception e, Object[] parameters) {
        logError(e);
        return parseErrorMessage(messageSource.getMessage(e.getClass().getName(), parameters,
                "Exception caught and thrown but no default message found under code.#1000", Locale.getDefault()));
    }
